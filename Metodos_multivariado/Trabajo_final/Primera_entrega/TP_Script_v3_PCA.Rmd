...
#CargasFactoriales['Dim.1'] %>% filter( Dim.1 > 0.7 | Dim.1 < -0.7) %>% arrange(Dim.1)
```
...
#### 4.2.5.2 Interpretación de los componentes principales obtenidos según matriz de varianza (este no lo usamos)
